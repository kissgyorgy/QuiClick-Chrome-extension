    ...
    setupDragAndDrop() {
        ...
        body.addEventListener('dragenter', (e) => {
            ...
            if (!document.getElementById('dropOverlay')) {
                ...
                overlay.className = 'fixed left-0 right-0 bottom-0 bg-blue-100 bg-opacity-10 border-4 border-dashed border-blue-400 z-40 flex items-center justify-center';
